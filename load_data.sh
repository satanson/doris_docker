...
${basedir}/mysql1.sh "use example_db; truncate table table2;"
...
DONE
echo ""
cat <<'DONE' | curl --location-trusted -u test:test -H "label:table2_20170707_$now" -H "column_separator:|" -T - http://${masterFe}/api/example_db/table2/_stream_load
...
${basedir}/mysql1.sh "use example_db; select * from table2;"
